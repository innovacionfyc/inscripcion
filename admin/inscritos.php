          ...
          <?php else: ?>
            ...
            foreach ($inscritos as $r): ?>
              <tr class="border-b hover:bg-gray-50">
                ...
                <td class="py-2 pr-3">
                  <?php if ($es_admin): ?>
                    <a href="editar_inscrito.php?id=
<?php echo (int) $r['id']; ?>&evento_id=
<?php echo $evento_id; ?>" class="inline-block bg-sky-600 hover:bg-sky-700 text-white px-3 py-1 rounded-lg">Editar</a>
